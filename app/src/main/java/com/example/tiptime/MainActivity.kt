...
fun TipTimeLayout() {
    ...
    Column(
        ...
        RoundTheTipRow(
            ...
            onRoundDownChanged = { roundDown = it },
            modifier = Modifier
                .padding(bottom = 32.dp)
                .fillMaxWidth()
        )
...
fun RoundTheTipRow(
    ...
    Column(
        ...
        Row(
            ...
            Text(
                text = stringResource(R.string.round_down_tip)
            )

            Switch(checked = roundDown, onCheckedChange = onRoundDownChanged,
                modifier = modifier
                    .fillMaxWidth()
                    .wrapContentWidth(Alignment.End))
        }
...
roundUp: Boolean, roundDown: Boolean): String {
